...
/**
 * Ticks the decorated {@link org.rossweir.behaviourtree.Node} the specified amount of times. Any
...
public final class RepeatUntilCountDecorator<T> extends Decorator<T> {
  ...
  /**
   * @param repeatCount The amount of times to tick the decorated {@link org.rossweir.behaviourtree.Node}.
   */
